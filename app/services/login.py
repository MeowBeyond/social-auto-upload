...
from app.core.config import BASE_DIR, LOCAL_CHROME_HEADLESS, LOCAL_CHROME_PATH, MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB
    ...
    async with async_playwright() as playwright:
        ...
        try:
            with conn.cursor() as cursor:
                cursor.execute(
                    'INSERT INTO user_info (type, filePath, userName, status) VALUES (%s, %s, %s, %s)',
